<template>
  <el-dialog
    ...
    <el-form class="alarmMessageBox-formItem" v-model="alarmDetailDataAlarm" label-position="right" label-width="76px">
			<div class="eqBorderColor marginBottom20">
				<div class="dialogTitle">{{$t('alarmCurrent.equipmentInfo')}}</div>
				<el-row :gutter="20" class="paddingTop10 paddingBottom10">
					<el-col :span="8">
					...
					<el-col :span="8">
						<el-form-item style="margin-bottom: 10px;" :label="$t('alarmCurrent.computerRoomName') + '：'">{{alarmDetailDataAlarm.roomName}}</el-form-item>
						<el-form-item style="margin-bottom: 10px;" :label="$t('alarmCurrent.location') + '：'">
							<span>{{alarmDetailDataAlarm.rackName}}</span>
							<span v-if="alarmDetailDataAlarm.rackPosition !== null">,{{alarmDetailDataAlarm.rackPosition}}U</span>
						</el-form-item>
					</el-col>
				</el-row>
			</div>
			<div class="eqBorderColor" style="padding-bottom: 30px;">
				<!--告警信息字段-->
				...
				<el-row class="marginTop10">
					<el-col :span="12">
						...
						<el-form-item :label="$t('alarmCurrent.alarmNumber') + '：'">
							<span v-if="alarmDetailDataAlarm.alarmLevel == 33" class="iconfontSuccess">{{alarmDetailDataAlarm.alarmTimes}}</span>
							<span v-if="alarmDetailDataAlarm.alarmLevel == 66" class="iconfontWarn">{{alarmDetailDataAlarm.alarmTimes}}</span>
							<span v-if="alarmDetailDataAlarm.alarmLevel == 99" class="iconfontError">{{alarmDetailDataAlarm.alarmTimes}}</span>
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<!--处理状态-->
				<div class="paddingLeft-10 marginTop10 marBottom10 fsBold12 titleBorder">
					<strong>{{$t('alarmCurrent.processStatus')}}</strong>
					<div class="line"></div>
				</div>
				...
				<div class="paddingLeft-10 marginTop10 marBottom10 fsBold12 titleBorder">
					<strong>{{$t('alarmCurrent.alarmContent')}}</strong>
					<div class="line"></div>
				</div>
				<el-form-item :label="$t('alarmCurrent.part') + '：'">
					{{alarmDetailDataAlarm.part}}
				</el-form-item>
				<el-form-item style="margin-bottom: 10px;" :label="$t('alarmCurrent.alarmInfo') + '：'">
					{{alarmDetailDataAlarm.currentStatus}}
				</el-form-item>
				<div class="paddingLeft-10 marginTop10 marBottom10 fsBold12 titleBorder">
					<strong>{{$t('alarmCurrent.alarmDescription')}}</strong>
					<div class="line"></div>
				</div>
				<el-form-item label=" ">
				...
				<el-form-item :label="$t('alarmCurrent.dealWithWays') + '：'">
