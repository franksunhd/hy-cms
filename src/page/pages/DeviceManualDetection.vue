        ...
        <div class="DeviceManualDetection-box-right">
          ...
          <el-form inline>
            <div v-for="(list,index) in lists" class="DeviceManualDetection-box-right-bottom">
              <el-button @click="del(index)" style="float: right;margin-top: 20px;margin-right: 20px;"><i
              ...
              <el-form-item v-if="type == 2&&list.snmpVersion==='3'" label="SNMP安全级别:">
                <el-select v-model="list.snmpSecurityLevel" placeholder="请选择" class="width200"
                           @change="selectsnmpSecurityLevel(list.snmpSecurityLevel)">
              ...
              <el-form-item v-if="type == 2&&list.snmpVersion==='3'" label="SNMP验证算法:">
                <el-select v-model="list.snmpAuthAlgorithm" placeholder="请选择" class="width200"
                           @change="selectsnmpAuthAlgorithm(list.snmpAuthAlgorithm)">
                  <el-option v-for="item in VerifyTheAlgorithm" :key="item.value" :label="item.label"
                             :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
              <el-form-item v-if="type == 2&&list.snmpVersion==='3'" label="SNMP验证码:">
                <el-input type="password" v-model="list.snmpAuthPassword" class="width200"></el-input>
              </el-form-item>
              <el-form-item v-if="type == 2&&list.snmpVersion==='3'" label="SNMP私有验证算法:">
                <el-select v-model="list.snmpPrivacyAlgorithm" placeholder="请选择" class="width200"
                           @change="selectsnmpPrivacyAlgorithm">
                  <el-option v-for="item in PrivateVerificationAlgorithm " :key="item.value" :label="item.label"
                             :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
              <el-form-item v-if="type == 2&&list.snmpVersion==='3'" label="SNMP私有密码:">
                <el-input type="password" v-model="list.snmpPrivacyPassword" class="width200"></el-input>
              </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      selectsnmpSecurityLevel(val) {
        if (val === 'noAuthNoPriv') {
          this.VerifyTheAlgorithm = [{
            value: 'MD5',
            label: 'MD5'
          }];
          this.PrivateVerificationAlgorithm = [{
            value: 'DES',
            label: 'DES'
          }]
      ...
      //验证算法
      selectsnmpAuthAlgorithm(val) {
      },

      //私有验证算法
      selectsnmpPrivacyAlgorithm() {
