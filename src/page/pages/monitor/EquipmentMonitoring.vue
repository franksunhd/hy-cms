	...
	<Box>
		...
		<div class="padding20">
			...
			<el-form :model="formItem" inline label-width="150px">
				...
				<el-form-item label="厂商:" style="width: 30%;">
			...
			<el-table :data="tableData" stripe @cell-click="cellClickColumn">
              ...
              {{scope.$index+(options.currentPage - 1) * options.pageSize + 1}}
				...
				<el-table-column label="监测状态" prop="workStatus" header-align="left" align="left">
					<template slot-scope="scope">
				...
				<el-table-column prop="status" label="设备状态" header-align="left" align="left">
					<template slot-scope="scope">
				...
				<el-table-column prop="AssetInformation" label="资产信息" header-align="left" align="left" />
				<!--<template slot-scope="scope">
				...
				<el-table-column prop="servicetag" label="序列号" header-align="left" align="left" />
				<el-table-column prop="ManufacturersModel" label="厂商型号" header-align="left" align="left" />

				<el-table-column prop="type" label="设备类型" header-align="left" align="left" />

				<el-table-column prop="lastMonitorTime" label="更新时间" header-align="left" align="left" />

				<el-table-column prop="AssetInformation" label="操作" header-align="left" align="left" />
		...
		<!--设备告警详情弹出层-->
		<el-dialog class="alarmCurrentBox" :title="$t('alarmCurrent.addUpdateAlarm')" append-to-body :visible.sync="dialogVisible" :close-on-click-modal="false" :close-on-press-escape="false">
					...
					switch(res.status) {
						case 200:
							...
							for(var i = 0; i < Income1.length; i++) {
								Income.push({
									workStatus: Income1[i].workStatus,/*监测状态*/
									status: Income1[i].status,/*设备状态*/
									AssetInformation: Income1[i].deviceName+','+Income1[i].ip,/*资产信息*/
									servicetag: Income1[i].servicetag,/*序列号*/
									ManufacturersModel: Income1[i].manufacturer+','+Income1[i].model,/*厂商型号*/
									type: Income1[i].type,/*设备类型*/
									lastMonitorTime: Income1[i].lastMonitorTime,/*更新时间*/
									type: Income1[i].type,/*操作*/
